    ...
    const register = (e) => {
        ...
        .then((userCredential) => {
          ...
          Alert.alert(
            ...
            [
                { text: 'Next ' , onPress :() => navigation.navigate('bottom')}
            ])
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.ImageContainer}>
                    ...
                    <Text style={styles.Headings}>Welcome Login!</Text>
                    ...
                    <View style={{ flexDirection: "row", alignItems: 'center', justifyContent: 'center', minHeight: 40, height: 40 }}>
                        ...
                        <Pressable style={{ height: '100%', justifyContent: 'center', marginLeft: 5 }} onPress={() => navigation.navigate("SignUp")}>
